...
import styles from './snippetlanguageprojectboard.module.scss';
...
export interface SnippetLanguageProjectBoardProps {
  className?: string;
  selectedLanguage: string;
  onClose: () => void;
}

export const SnippetLanguageProjectBoard: React.FC< SnippetLanguageProjectBoardProps> = ({ className, selectedLanguage, onClose }:  SnippetLanguageProjectBoardProps) => {
